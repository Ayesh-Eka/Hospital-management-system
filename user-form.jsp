	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>User Category</label> <input type="text" value="<c:out value='${user.category}' />" class="form-control" name="category">
				</fieldset>
			...
			<br>
			<a href="user-index.jsp" class="btn btn-success">Home</a></button>
	</div>
</body>
</html>